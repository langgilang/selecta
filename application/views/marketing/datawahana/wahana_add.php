    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="<?= site_url('marketing/proses'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                        ...
                        <button type="submit" id="<?= $page ?>" class="btn btn-primary float-right">Submit</button>
                    </div>
                </form>
            </div>
        </div>
