...
<head>
  ...
  <link href="<?= base_url('assets/assets_parallaxs/') ?>img/apple-touch-icon.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <!-- <a href="index.html" class="logo"><img src="<?= base_url('assets/assets_parallaxs/') ?>img/logo.png" alt="" class="img-fluid"></a>-->
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="<?= base_url('assets/assets_parallaxs/') ?>img/portfolio/portfolio-1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('assets/assets_parallaxs/') ?>img/portfolio/portfolio-2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('assets/assets_parallaxs/') ?>img/portfolio/portfolio-3.jpg" alt="">
                </div>
